...
var (
	...
	ErrorMultiUserPublicAPIClosed     = NewError(incr(400), lang{zh: "多用户开放接口已经关闭,请联系管理员配置 config.user.is-enable 选项", en: "Multi-user open interface has been closed, please contact the administrator to configure the config.user.is-enable option"})
